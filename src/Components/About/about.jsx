  ...
  return (
    <div id='about' className='w-full'>
      <div className='flex flex-col items-center'>
        <div className='text-[#1ea297] ml-14 mb-6' >ABOUT ME</div>
        <div className='text-[#1ea297] ml-14 text-4xl font-bold font-mono mb-10' ><p >Building With Purpose, <span className='text-white'>coding with passion</span></p></div>
        <div className='text-gray-400 ml-14 mr-10 xl:ml-20'>
        ...
        <div className='text-gray-400 shadow-sm shadow-gray-600 pb-4 px-2 mb-20 ml-14 mr-10 mt-8 border border-gray-600 w-fit h-fit text-center pt-4 font-semibold text-xl
         bg-[#11171c]'>
      ...
      <div className='w-full h-fit flex flex-col items-center md:grid md:grid-cols-2 md:justify-items-center'>
        ...
        <div className='text-gray-400 w-110 mb-15 p-4 border  border-gray-800 shadow-sm shadow-gray-700 
