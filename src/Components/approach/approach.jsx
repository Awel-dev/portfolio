...
const approach = () => {
  return (
    <div id='approach' className='flex flex-col items-center justify-center mt-10'>
      ...
      <div className=' grid grid-cols-1 justify-items-center  mb-20 xl:grid xl:grid-cols-3'>
        <div className=' h-100 border border-gray-600 mb-8 mx-15 px-10 pt-30 flex flex-col items-center  w-[90%] sm:w-100 bg-gray-950 md:w-130 xl:w-90 xl:mx-6
        ...
        <div className='h-100 border mb-8 mx-15 border-gray-600 px-10 pt-30 flex flex-col items-center  w-[90%] sm:w-100 bg-gray-950 md:w-130 xl:w-90 xl:mx-6
